  ...
  if (specialNeedsProgram) {
    return (
      <section className="post-purchase-membership" aria-labelledby="choose-special-needs-program-title">
        <p className="eyebrow">Previous Special Needs checkout</p>
        <h2 id="choose-special-needs-program-title">Your $39 payment counts toward the program total.</h2>
        <p>Special Needs Nutrition now uses one $597 program total, with the standard $39 initial-care portion included. Do not make another full $597 payment from this page.</p>
        <div className="membership-default-callout">
          <strong>Contact billing for an adjusted enrollment link</strong>
