    ...
    sections: [
      {
        ...
        questions: [
          ...
          { id: "met_conditions", label: "Select any health conditions that apply to you.", type: "multi", required: true, options: ["High blood pressure", "High cholesterol or triglycerides", "Prediabetes", "Type 1 diabetes", "Type 2 diabetes", "Fatty liver disease", "Polycystic ovary syndrome", "Sleep apnea", "Kidney disease", "None of these", "Not sure"] },
          { id: "met_meds", label: "List your current medications and any medication allergies. Include insulin, diabetes medicine, and weight-loss products.", type: "text", required: true },
        ],
      },
      {
        title: "A few important safety questions",
        note: "Your answers help your clinician focus the review and prepare for your conversation.",
        questions: [
          ...
          { id: "met_safety", label: "Select anything that applies to you now or in the past.", type: "multi", required: true, options: ["Medullary thyroid cancer in me or my immediate family, or MEN 2", "Pancreatitis", "Gallstones or significant gallbladder disease", "Gastroparesis, bowel obstruction, or severe digestive disease", "Serious reaction to a GLP-1 or weight-loss medication", "Frequent severe low blood sugar", "Current or past eating disorder", "Severe uncontrolled depression or current thoughts of self-harm", "None of these", "Not sure"] },
        ],
      },
    ],
  },
