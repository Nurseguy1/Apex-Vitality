    ...
    <main className="self-pay-page">
      ...
      <article className="legal-page">
        ...
        {isMembership ? (
          ...
          <p>The initial consultation costs $69 once. It does not start a recurring charge and does not require membership. Laboratory orders and testing are not included in this consultation. You must separately authorize and purchase the $149/month Focused Care membership before any lab orders.</p>
        ) : (
          <p>The initial consultation costs $69 once and does not require membership. It does not start a recurring charge or include laboratory orders or testing. A separate $149/month Focused Care membership is required before any lab orders.</p>
        )}
