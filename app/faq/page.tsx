...
const questions = [
  ...
  ["What does the $149/month membership include?", "Focused Care includes one scheduled clinician appointment each month and four follow-up lab checks per year, including lab testing costs and clinician interpretation. The separate $39 initial consultation does not require membership. Membership is required before any lab orders. Medication, pharmacy charges, supplies, shipping, and services outside these inclusions are separate."],
