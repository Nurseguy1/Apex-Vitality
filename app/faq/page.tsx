...
const questions = [
  ...
  ["What does the introductory visit cost?", "The introductory visit is $59 USD. When the comprehensive follow-up is completed within 90 days, the $59 is credited toward its total price."],
  ["What do memberships cost?", "Apex Treatment Memberships begin at $499 USD per month, Apex Performance begins at $749 USD per month, and limited-enrollment Apex Private Client Care begins at $1,250 USD per month. Final program pricing depends on the selected treatment experience and its included services."],
