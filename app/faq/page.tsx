...
const questions = [
  ...
  ["What does root-cause-oriented education mean?", "It means exploring how nutrition, digestion, sleep, stress, movement, habits, and wellness-related lab patterns may fit together. Coaching may identify possible contributing patterns and practical areas to support, but it does not diagnose the root cause of symptoms or replace medical evaluation."],
