...
const questions = [
  ...
  ["What does the initial consultation cost?", "The comprehensive new patient consultation is $325. It includes an individualized clinical evaluation and care planning, but does not guarantee a prescription or membership enrollment."],
  ["What do memberships cost?", "Apex Core is $225 per month and Apex Performance is $375 per month. Medications, laboratory testing, pharmacy charges, imaging, and outside services are separate unless expressly stated."],
