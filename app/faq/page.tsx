...
const questions = [
  ...
  ["What do memberships cost?", "Apex Essential is $149 USD per month, Apex Performance is $375 USD per month, and limited-enrollment Apex Private Client Care begins at $750 USD per month. Medications, laboratory testing, pharmacy charges, imaging, and outside services are separate unless expressly stated."],
