...
const questions = [
  ...
  ["What does the initial care visit cost?", "The initial care visit is $259 USD and includes the clinician visit plus prescription coordination or a laboratory kit."],
