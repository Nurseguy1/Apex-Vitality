    ...
    <main>
      ...
      <section className="membership-terms">
        ...
        <div>
          ...
          <p><strong>Getting started:</strong> The initial consultation is $69. Your ongoing membership is $149/month.</p>
          ...
          <p><strong>Monthly renewal:</strong> $149 is charged when you enroll in membership, then monthly until canceled. The $69 consultation does not automatically enroll you. Purchasing both the consultation and first membership month totals $218. Canceling stops future renewals; it does not prorate a month already purchased.</p>
