  ...
  return (
    <main>
      ...
      <article className="legal-page">
        ...
        <h1>Both services are available in California.</h1>
        ...
        <p>This is educational wellness coaching, not medical care. Enrollment is available only to clients physically located in California during appointments. It may include educational review of wellness-related laboratory patterns, but it does not include diagnosis, treatment, prescribing, diagnostic testing as medical care, or clinical interpretation of laboratory results.</p>
