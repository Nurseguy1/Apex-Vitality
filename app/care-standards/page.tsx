  ...
  return (
    <main>
      ...
      <article className="legal-page">
        ...
        <p>
          Prices and inclusions are presented before checkout. Payment does not guarantee medical eligibility or a prescription. Refund, recurring-payment, pharmacy, and outside-service terms are disclosed in the applicable checkout and written agreements.
        </p>
        <p>
