    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual" aria-label="Telehealth consultation">
          ...
          <div className="visit-card"><span>Concierge telemedicine</span><strong>Executive-level attention. Clinically grounded care.</strong><p>Your history, goals, and lifestyle—considered holistically.</p></div>
        </div>
      </section>
