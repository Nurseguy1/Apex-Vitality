...
const steps = [
  ...
  ["3", "Meet with your clinician", "Discuss your history, goals, medications, symptoms, and relevant data; learn what they mean; and build a treatment plan designed to help you achieve your goals."],
